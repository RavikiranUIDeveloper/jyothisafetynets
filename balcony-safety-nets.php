...
<head>
   ...
   <title>Balcony Safety Nets</title>
   <!-- Fav Icon -->
                        ...
                        <div class="col-lg-12">
                           <div class="breadcrumbs creote">
                              <ul class="breadcrumb m-auto">
                                 ...
                                 <li class="active">Balcony Safety Nets</li>
                              </ul>
                           </div>
                        </div>
                     </div>
                           ...
                           <article class="clearfix service type-service status-publish has-post-thumbnail hentry">
                              <div class="title_all_box style_one dark_color">
                                 <div class="title_sections left">
                                    <img src="assets/images/service/balconysafety.jpg" alt="">
                                       <!--===============spacing==============-->
                                       <div class="pd_bottom_10"></div>
                                       <!--===============spacing==============-->
                                    <h3 style="font-size:25px;">Balcony Safety Nets</h3>
                                    <p>The balcony is where people relax at times of leisure in their home and prevent unwanted situations taking place. Get your balcony, secured by our balcony safety nets. Custom designed netting is installed across the open areas of balconies, windows and staircases. For another layer of balcony safety consider installing restrictor on your balcony doors and preventing kids from going out onto the balcony alone.</p>
                                    <p>These balcony, security screens are strong, transparent nylon thread coloured offering security without compromising the aesthetics of apartments. They are set to windows, partitions, balconies, stairs and floors providing protection without sacrificing the ventilation and lightness of a metallic balcony fence.</p>
                                 </div>
                              </div>
