                        ...
                        <div class="col-lg-12">
                           <div class="breadcrumbs creote">
                              <ul class="breadcrumb m-auto">
                                 ...
                                 <li class="active">Bird Spikes</li>
                              </ul>
                           </div>
                        </div>
                     </div>
                           ...
                           <article class="clearfix service type-service status-publish has-post-thumbnail hentry">
                              <div class="title_all_box style_one dark_color">
                                 <div class="title_sections left">
                                    <img src="assets/images/service/birdspikes.jpg" alt="">
                                       <!--===============spacing==============-->
                                       <div class="pd_bottom_10"></div>
                                       <!--===============spacing==============-->

                                       <h3 style="font-size:25px;">Bird Spikes</h3>
                                    <p>Balcony Safety Net offer Spikes that technologically advanced bird menace solutions in bird proofing your residence and office with the Bird Spikes and pigeon spikes. Bird Spikes do not harm birds at all. It is highly eco-friendly and hence quite popular.</p>
                                    <p>Bird spikes are made of highest quality marine grade stainless steel on a polycarbonate base or hard PVC. No more worries about pigeon droppings or diseases cause by birds. Say good-bye to bird menace permanently. Pigeon spikes installation is a cost effective and economical solution to pigeon menace.</p>
                                 </div>
                              </div>
