...
<head>
   ...
   <title>Children Safety Nets</title>
   <!-- Fav Icon -->
            ...
            <div class="page_header_default style_one ">
               <div class="parallax_cover">
                  <div class="simpleParallax">
                     <img src="assets/images/net.jpg"  alt="bg_image" class="cover-parallax"></div>
               </div>
                        ...
                        <div class="col-lg-12">
                           <div class="breadcrumbs creote">
                              <ul class="breadcrumb m-auto">
                                 ...
                                 <li class="active">Children Safety Nets</li>
                              </ul>
                           </div>
                        </div>
                     </div>
                           ...
                           <article class="clearfix service type-service status-publish has-post-thumbnail hentry">
                              <div class="title_all_box style_one dark_color">
                                 <div class="title_sections left">
                                    <img src="assets/images/service/childsafety.jpg" alt="">
                                       <!--===============spacing==============-->
                                       <div class="pd_bottom_10"></div>
                                       <!--===============spacing==============-->
                                    <h3 style="font-size:25px;">Children Safety Nets</h3>
                                    <p>Our products can do child proof at most every balcony, window, stairs and open spaces. Enjoy the fresh air while keeping your home safe for babies and toddlers. For another layer of balcony safety nets, consider installing restrictions on your balcony doors, preventing kids from going out onto the balcony alone. Don’t be panic get install children safety nets, though it has special expertise in fixing children safety nets for balconies. We ensure that these safety nets for my are well equipped and properly fixed in your open balcony.</p>
                                    <p>Usually apartments are built with awesome looks to get attracted by public. So apartments are mostly built with balconies, stairs and gallery areas. Therefore, children fond of playing in balconies always. we have the best permanent solution for getting rid of accidents in high rise buildings. Children net for balconies are specially produced to protect kids, toddlers, babies and old members.</p>
                                    <p>These safety nets for balcony suitable for both indoor and outdoor use anywhere you loved need protection from open spaces more than two meters above ground level. It is unobtrusive and easily blends into the interiors and exterior without blocking light or air flow. The net does not require maintenance conditions. The safety net will not continue to tear. Both the nets and fixing have been treated to resist sun damage. Also, there are no sharp edges that could harm your child.</p>
                                 </div>
                              </div>
