...
<head>
   ...
   <title>Cricket Practice Safety Nets</title>
   <!-- Fav Icon -->
                        ...
                        <div class="col-lg-12">
                           <div class="breadcrumbs creote">
                              <ul class="breadcrumb m-auto">
                                 ...
                                 <li class="active">Cricket Practice Safety Nets</li>
                              </ul>
                           </div>
                        </div>
                     </div>
                           ...
                           <article class="clearfix service type-service status-publish has-post-thumbnail hentry">
                              <div class="title_all_box style_one dark_color">
                                 <div class="title_sections left">
                                    <img src="assets/images/service/cricket.jpg" alt="">
                                       <!--===============spacing==============-->
                                       <div class="pd_bottom_10"></div>
                                       <!--===============spacing==============-->
                                    <<h3 style="font-size:25px;">Cricket Practice Safety Nets</h3>
                                    <p>Sports net is useful in creating safer space out of a limited area. Many cricket pitches can be created in a given area if it is separated by nets. Nets can be used on the terraces of buildings or in compounds to restrict balls from damaging property or threatening life.</p>
                                    <p>The player enjoys his game as he is allowed to play powerful shots or kick the ball as hard as he wants in the netted ground. We have special nets made for indoor cricket and football. The nets are UV stabilized for long life. They are designed to withstand impacts caused by balls and players.</p>
                                    <p>Cricket Net & Football Net are manufactured using high-grade material and is appreciated for their strong construction and long life. Furthermore, the net is in compliance with the set international standards and norms. Our exclusive array is offered to the clients in different specifications, depending upon their requirements. Easy to install and high tear strength, this net is highly demanded in the market.</p>
                                 </div>
                              </div>
