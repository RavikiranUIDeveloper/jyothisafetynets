...
<head>
   ...
   <title>Building Safety Nets</title>
   <!-- Fav Icon -->
                        ...
                        <div class="col-lg-12">
                           <div class="breadcrumbs creote">
                              <ul class="breadcrumb m-auto">
                                 ...
                                 <li class="active">Building Safety Nets</li>
                              </ul>
                           </div>
                        </div>
                     </div>
                           ...
                           <article class="clearfix service type-service status-publish has-post-thumbnail hentry">
                              <div class="title_all_box style_one dark_color">
                                 <div class="title_sections left">
                                    <img src="assets/images/service/building.jpg" alt="">
                                       <!--===============spacing==============-->
                                       <div class="pd_bottom_10"></div>
                                       <!--===============spacing==============-->
                                    <h3 style="font-size:25px;">Building Safety Nets</h3>
                                    <p>We are expertisation in fixing Glass Building Safety Nets, Which protect the outside glass. Glass Building Nets are used mainly 2 purposes</p>
                                    <p>If any protest happening near the building, there might be the chance that someone may throw stones on buildings which cost in heavily, to avoid such thing glass safety nets are used. Example in Hyderabad protest many building owners fixed our nets and saved lot of money, which would cost them on glass fixing</p>
                                    <p>In any case, if the glass is suspected that it may fall down, in such case, these glass building nets can be used.</p>
                                 </div>
                              </div>
