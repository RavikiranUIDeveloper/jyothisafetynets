...
<head>
   ...
   <title>Industrial Safety Nets</title>
   <!-- Fav Icon -->
                        ...
                        <div class="col-lg-12">
                           <div class="breadcrumbs creote">
                              <ul class="breadcrumb m-auto">
                                 ...
                                 <li class="active">Industrial Safety Nets</li>
                              </ul>
                           </div>
                        </div>
                     </div>
                           ...
                           <article class="clearfix service type-service status-publish has-post-thumbnail hentry">
                              <div class="title_all_box style_one dark_color">
                                 <div class="title_sections left">
                                    <img src="assets/images/service/industrial.jpg" alt="">
                                       <!--===============spacing==============-->
                                       <div class="pd_bottom_10"></div>
                                       <!--===============spacing==============-->
                                    <h3 style="font-size:25px;">Industrial Safety Nets</h3>
                                    <p>Industrial safety nets are designed to protect people from product damage in warehouses or storage areas. Balcony Safety Nets forms a durable load containment barrier designed for stacked materials on warehouse shelves and storage racks. Our industrial safety nets are helping in improving safety for employees, protect traffic areas and workstations, reduce damage to warehouse goods, prevents falls from between back to back racks.</p>
                                    <p>At our company industrial safety nets designed to catch debris or a containment of both and are ideal for use in construction and general industry. Our standard quality materials are meeting available specific job site requirements. Industry safety nets must be heavy duty and incorporate a UV coating stand up to the elements outdoors. Industrial safety nets are typically lighter, but just strong and flame retardant protections for added safety.</p>
                                 </div>
                              </div>
