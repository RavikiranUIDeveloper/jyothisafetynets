...
<head>
   ...
   <title>Mosquito Safety Nets</title>
   <!-- Fav Icon -->
                        ...
                        <div class="col-lg-12">
                           <div class="breadcrumbs creote">
                              <ul class="breadcrumb m-auto">
                                 ...
                                 <li class="active">Mosquito Safety Nets</li>
                              </ul>
                           </div>
                        </div>
                     </div>
                           ...
                           <article class="clearfix service type-service status-publish has-post-thumbnail hentry">
                              <div class="title_all_box style_one dark_color">
                                 <div class="title_sections left">
                                    <img src="assets/images/service/mosquito...jpg" alt="">
                                       <!--===============spacing==============-->
                                       <div class="pd_bottom_10"></div>
                                       <!--===============spacing==============-->
                                    <h3 style="font-size:25px;">Mosquito Safety Nets</h3>
                                    <p>We are expert in mosquito & insect proofing of windows, doors, Ventilators, balconies etc. We make you free from Mosquito & Insects, Communicable disease etc. and make a happy home atmosphere</p>
                                    <p>They are flexible and can be installed easily on the windows and provide protection against insects and mosquitoes. One is to have a parallel with decreasing power of mosquito repellent, mats and coils in driving off the mosquitoes from home. The best alternative is to prevent them from entering homes. This can be done by either keeping the windows shut or by using mosquito nets on windows will allow fresh air to come in aid at the same keep the mosquitoes out.</p>
                                    <p>The prices will vary based the type of materials used and the number of windows that need to be covered with mosquito nets. No side effects from chemicals used in the coils or mats. Avoid skin problems like skin cancer, asthma, sinus problems, lung problems etc.. The ultimate device to fight the mosquito menace.</p>
                                 </div>
                              </div>
