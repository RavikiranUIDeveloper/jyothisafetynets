...
<head>
   ...
   <title>Pigeon Nets for Balconies</title>
   <!-- Fav Icon -->
                        ...
                        <div class="col-lg-12">
                           <div class="breadcrumbs creote">
                              <ul class="breadcrumb m-auto">
                                 ...
                                 <li class="active">Pigeon Nets for Balconies</li>
                              </ul>
                           </div>
                        </div>
                     </div>
                           ...
                           <article class="clearfix service type-service status-publish has-post-thumbnail hentry">
                              <div class="title_all_box style_one dark_color">
                                 <div class="title_sections left">
                                    <img src="assets/images/service/pigeon-net.jpg" alt="">
                                       <!--===============spacing==============-->
                                       <div class="pd_bottom_10"></div>
                                       <!--===============spacing==============-->
                                    <h3 style="font-size:25px;">Pigeon Nets for Balconies</h3>
                                    <p>Counting on our wide experience and technology in this sector, we are relying amongst the leading manufacturers and suppliers of Anti-birds, safety nets, which is widely used in the agricultural industry, these nets are ideal for plant protection system. Our costs, fixed up at rate of market leading prices. These nets are complete protection of the crops against birds.</p>
