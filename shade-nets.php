                           ...
                           <article class="clearfix service type-service status-publish has-post-thumbnail hentry">
                              <div class="title_all_box style_one dark_color">
                                 <div class="title_sections left">
                                    <img src="assets/images/service/shadenet.jpg" alt="">
                                       <!--===============spacing==============-->
                                       <div class="pd_bottom_10"></div>
                                       <!--===============spacing==============-->
                                    <h3 style="font-size:25px;">Shade Nets</h3>
                                    <p>Agro Shade nets are formed with the primary objective of producing shade nets uses for agriculture and commercial purposes. Agro Shade nets all kinds of shade nets with different thickness.</p>
                                    <p><b>Agro Shade Net Tape Type</b></p>
                                    <p>The shading nets fulfil the task of giving appropriate micro-climate condition of the plant. When grown under controlled conditions. These plants must be developed in Green house, under shades that allows only a diffuse light to pass through.</p>
                                    <p>Plant Production: Nets against Penetration of Butterflies a Different Insects. Production against Natural Weather Disturbances against Winds, Birds, Hail and Frost. Shading Nets for Reduction of Solar Radiation to Avoid Damage to Animals and Plants. Thermal – Reflective Nets for A Creation Of An Adequate Micro climate Within Green Houses.</p>
                                    <p><b>Type Used : Green House, Construction Net, Nursery Net, Car Parking Net, Tent House</b></p>
                                 </div>
                              </div>
