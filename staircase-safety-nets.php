...
<head>
   ...
   <title>Staircase Safety Net</title>
   <!-- Fav Icon -->
                        ...
                        <div class="col-lg-12">
                           <div class="breadcrumbs creote">
                              <ul class="breadcrumb m-auto">
                                 ...
                                 <li class="active">Staircase Safety Net</li>
                              </ul>
                           </div>
                        </div>
                     </div>
                           ...
                           <article class="clearfix service type-service status-publish has-post-thumbnail hentry">
                              <div class="title_all_box style_one dark_color">
                                 <div class="title_sections left">
                                    <img src="assets/images/service/staircase.jpg" alt="">
                                       <!--===============spacing==============-->
                                       <div class="pd_bottom_10"></div>
                                       <!--===============spacing==============-->
                                    <h3 style="font-size:25px;">Staircase Safety Net</h3>
                                    <p>Staircase safety nets are mainly for the kindergarten and children at home. Staircase prevents the children from falling. We can provide hundred percent care of children all day; there are lots of possibilities for the accident to happen in schools, kindergarten, and homes. Staircase case safety nets provide the best solution for all sorts of problems.</p>
                                    <p>Staircase safety nets for children is not only for the children, but also for elderly persons. Sometimes grown people also need more care and attention as children. So staircase safety nets are essential for older people and as well as kids.</p>
                                    <p>Staircase safety nets are highly prescribed in the hospitals, shopping malls, schools, public areas and also for homes. Staircase safety nets act as a barrier to that staircase, it prevents the people from falling and slipping. Moreover, it also can help as a compound barrier.</p>
                                 </div>
                              </div>
